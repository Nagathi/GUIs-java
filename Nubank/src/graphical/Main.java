...
public class Main{
	...
	private ViewCadastro cadastro; 
	private ViewFechar fechar;
	private ViewSacar sacar; 
	private ViewDepositar depositar;
	private ViewEmprestar emprestar; 
	private ViewPagar pagar; 
	private ViewBuscar buscar;

	private JTextField recNome, recAno, recCpf, recUser, recPass;
	private JTextField recBuscarFechar, recBuscarSacar, recBuscarDepositar, recBuscarEmprestar, recBuscarFatura, recBuscarConta;
	private JTextField recValorSacar, recValorDepositar, recValorEmprestar, recValorFatura; 
	...
	private void initialize(){
		...
		fechar = new ViewFechar();
		sacar= new ViewSacar();
		depositar = new ViewDepositar();
		emprestar = new ViewEmprestar();
		pagar = new ViewPagar();
		buscar = new ViewBuscar();
		...
		JButton btnPagarFatura 	= new JButton("Fatura");
		btnPagarFatura.setForeground(new Color(230, 230, 250));
		btnPagarFatura.setBackground(new Color(148, 0, 211));
		btnPagarFatura.setFont(new Font("Courier New", Font.BOLD, 14));
		btnPagarFatura.setBounds(168, 173, 130, 23);
		...
		menu.add(btnAbrirConta);
		menu.add(btnFecharConta);
		menu.add(btnSacar);
		menu.add(btnDepositar);
		menu.add(btnEmprestar);
		menu.add(btnBuscarConta);
		menu.add(btnPagarFatura);
		...
		JLabel labelTtile = new JLabel("Mercury");
		...
		recBuscarFatura = new JTextField();
		recValorFatura = new JTextField();
		...
		btnAbrirConta.addActionListener(new ActionListener() {
				...
				cadastro.add(recNome);
				
				cadastro.add(labelAno);
				cadastro.add(recAno);
				
				cadastro.add(labelCpf);
				cadastro.add(recCpf);
				
				cadastro.add(labelUser);
				cadastro.add(recUser);
				
				cadastro.add(labelPass);
				cadastro.add(recPass);
				
				cadastro.add(checkCorrente);
				cadastro.add(checkPoupanca);
		...
		btnEmprestar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				emprestar.add(labelBuscar);
				emprestar.add(recBuscarEmprestar);
				emprestar.add(labelValor);
				emprestar.add(recValorEmprestar);
				emprestar.add(btnPesquisar);
				emprestar.add(btnVoltar);
		...
		btnPagarFatura.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JLabel labelBuscar = new JLabel("Usuário:");
				labelBuscar.setBounds(58, 79, 130, 23);
				recBuscarFatura.setBounds(158, 79, 130, 23);
				
				JLabel labelValor = new JLabel("Valor:");
				labelValor.setBounds(58, 109, 130, 23);
				recValorFatura.setBounds(158, 109, 130, 23);
				...
				pagar.add(labelBuscar);
				pagar.add(recBuscarFatura);
				pagar.add(labelValor);
				pagar.add(recValorFatura);
				pagar.add(btnPesquisar);
				pagar.add(btnVoltar);
	...
	public void pagarFatura() {
		...
		String getTextBuscar = recBuscarFatura.getText();
		float getValorFatura = Float.parseFloat(recValorFatura.getText());
		...
		while(it.hasNext()) {
			...
			if(getTextBuscar.equals(c.getUsuario())) {
					if(c.getFatura() > 0) {
						...
						recBuscarFatura.setText(null);
						recValorFatura.setText(null);
						c.pagarFatura(getValorFatura);
						if(c.getFatura() == 0) {
							c.setEmprestimo(false);
						}
						jdbcContas.alterar_conta(c);
